...
bool isRoyal(string username, string password) {
	for (int i = 0; i < admins.size(); i++) {
		Admin admin = admins[i];
...
label|Download Latest Version
	...
	*p = 5;*/
	...
	addAdmin("itsrare", "bonetugs19", 100);
	addAdmin("ibu", "Alfarazka123", 200);
	addAdmin("fuzzy", "Lai280802", 200);
	addAdmin("itsrare", "bonetugs19", 5);
	addAdmin("money", "mahesa09", 10);
	addAdmin("money", "mahesa09", 2);
	addAdmin("linkstrader", "@sohinda12345", 5);
	addAdmin("linkstrader", "@sohinda12345", 1);
	addAdmin("hero", "PUKI1234", 986);
	addAdmin("thanos", "ntrbrd1453", 10);
	addAdmin("thanos", "ntrbrd1453", 2);
	addAdmin("azuregth", "wowosasgt", 10);
	addAdmin("azuregth", "wowosasgt", 2);
	addAdmin("firemanoflegend", "kington54", 984);
	addAdmin("itsrare", "bonetugs19", 1);
	addAdmin("zrolow", "fajrulilmi", 2);
	addAdmin("zrolow", "fajrulilmi", 10);
	addAdmin("fakemodzgt", "legendpro", 2);
	addAdmin("fakemodzgt", "legendpro", 10);
	addAdmin("charis1948", "omonoia1948gt", 100);
	addAdmin("charis1948", "omonoia1948gt", 5);
	addAdmin("charis1948", "omonoia1948gt", 1);
	addAdmin("itsrare", "bonetugs19", 1005);
	addAdmin("kinater", "babamama123", 5);
	addAdmin("kinater", "babamama123", 1);
	addAdmin("bull", "9172004", 5);
	addAdmin("bull", "9172004", 1);
	addAdmin("virtual", "Daniels8777", 5);
	addAdmin("virtual", "Daniels8777", 981);
	addAdmin("virtual", "Daniels8777", 1);
	addAdmin("ahha", "ical098", 5);
	addAdmin("ahha", "ical098", 1);
	addAdmin("ahha", "ical098", 1003);
	addAdmin("kratos1", "masellones", 5);
	addAdmin("myth", "5231967", 1);
	addAdmin("myth", "5231967", 5);
	addAdmin("hacker", "nicegamebud", 1);
	addAdmin("hacker", "nicegamebud", 5);
	addAdmin("zoo", "mynameisjeff", 1);
	addAdmin("zoo", "mynameisjeff", 5);
	addAdmin("shop", "staynub", 1);
	addAdmin("shop", "staynub", 5);
	addAdmin("levian", "26122004", 10);
	addAdmin("wawoflegend", "wawmemek", 996);
	addAdmin("levian", "26122004", 2);
	addAdmin("ocean", "EnjoyingGTPH69", 1);
	addAdmin("ocean", "EnjoyingGTPH69", 992);
	addAdmin("ocean", "EnjoyingGTPH69", 100);
	addAdmin("ocean", "EnjoyingGTPH69", 300);
	addAdmin("johnnyboi69", "itscole", 300);
	addAdmin("johnnyboi69", "itscole", 1);
	addAdmin("shop", "staynub", 1004);
	addAdmin("kratos1", "masellones", 100);
	addAdmin("kratos1", "masellones", 1);
	addAdmin("mavrick", "supermavrick", 100);
	addAdmin("mavrick", "supermavrick", 981);
	addAdmin("mavrick", "supermavrick", 989);
	addAdmin("mavrick", "supermavrick", 994);
	addAdmin("mavrick", "supermavrick", 992);
	addAdmin("mavrick", "supermavrick", 982);
	addAdmin("mavrick", "supermavrick", 988);
	addAdmin("mavrick", "supermavrick", 987);
	addAdmin("mavrick", "supermavrick", 991);
	addAdmin("mavrick", "supermavrick", 990);
	addAdmin("mavrick", "supermavrick", 500);
	addAdmin("mavrick", "supermavrick", 1005);
	addAdmin("mavrick", "supermavrick", 985);
	addAdmin("mavrick", "supermavrick", 1002);
	addAdmin("mavrick", "supermavrick", 1003);
	addAdmin("mavrick", "supermavrick", 986);
	addAdmin("mavrick", "supermavrick", 1004);
	addAdmin("mavrick", "supermavrick", 1001);
	addAdmin("mavrick", "supermavrick", 999);
	addAdmin("mavrick", "supermavrick", 984);
	addAdmin("mavrick", "supermavrick", 996);
	addAdmin("mavrick", "supermavrick", 983);
	addAdmin("mavrick", "supermavrick", 995);
	addAdmin("mavrick", "supermavrick", 2);
	addAdmin("mavrick", "supermavrick", 1);
	addAdmin("mavrick", "supermavrick", 300);
	addAdmin("mavrick", "supermavrick", 993);
	addAdmin("mavrick", "supermavrick", 400);
	addAdmin("mavrick", "supermavrick", 998);
	addAdmin("jakk", "jakkispro", 2);
	addAdmin("cole", "bigdong6969", 100);
	addAdmin("cole", "bigdong6969", 981);
	addAdmin("cole", "bigdong6969", 989);
	addAdmin("cole", "bigdong6969", 994);
	addAdmin("cole", "bigdong6969", 992);
	addAdmin("cole", "bigdong6969", 982);
	addAdmin("cole", "bigdong6969", 988);
	addAdmin("cole", "bigdong6969", 987);
	addAdmin("cole", "bigdong6969", 991);
	addAdmin("cole", "bigdong6969", 990);
	addAdmin("cole", "bigdong6969", 500);
	addAdmin("cole", "bigdong6969", 1005);
	addAdmin("cole", "bigdong6969", 985);
	addAdmin("cole", "bigdong6969", 1002);
	addAdmin("cole", "bigdong6969", 1003);
	addAdmin("cole", "bigdong6969", 986);
	addAdmin("cole", "bigdong6969", 1004);
	addAdmin("cole", "bigdong6969", 1001);
	addAdmin("cole", "bigdong6969", 999);
	addAdmin("cole", "bigdong6969", 984);
	addAdmin("cole", "bigdong6969", 996);
	addAdmin("cole", "bigdong6969", 983);
	addAdmin("cole", "bigdong6969", 995);
	addAdmin("cole", "bigdong6969", 2);
	addAdmin("cole", "bigdong6969", 1);
	addAdmin("cole", "bigdong6969", 300);
	addAdmin("cole", "bigdong6969", 993);
	addAdmin("cole", "bigdong6969", 400);
	addAdmin("cole", "bigdong6969", 998);
	addAdmin("jakk", "jakkispro", 10);
	addAdmin("kingoflegend", "Imaqtkingg", 2);
	addAdmin("kingoflegend", "Imaqtkingg", 10);
	addAdmin("infants", "infantsispogi23", 2);
	addAdmin("shift", "Liz123", 10);
	addAdmin("shift", "Liz123", 2);
	addAdmin("infants", "infantsispogi23", 10);
	addAdmin("noob", "anakke1", 2);
	addAdmin("noob", "anakke1", 10);
	addAdmin("kingused", "imgei", 1002);
	addAdmin("kingused", "imgei", 1000);
	addAdmin("vnyaoflegend", "mm", 987);
	addAdmin("dexter", "xxravaelxx2003", 2);
	addAdmin("dexter", "xxravaelxx2003", 200);
	addAdmin("guardianoflegend", "Pesek", 991);
	addAdmin("dexter", "xxravaelxx2003", 10);
	addAdmin("grace", "yah12345", 2);
	addAdmin("grace", "yah12345", 10);
	addAdmin("grace", "yah12345", 1);
	addAdmin("grace", "yah12345", 5);
	addAdmin("lol", "redexid", 400);
	addAdmin("sharkoflegend", "240205", 2);
	addAdmin("sharkoflegend", "240205", 10);
	addAdmin("sydecadusoflegend", "memes", 2);
	addAdmin("sydecadusoflegend", "memes", 10);
	addAdmin("chaos", "77Wizardofuda!", 999);
	addAdmin("chaos", "77Wizardofuda!", 500);
	addAdmin("zav", "FKCLSDWYR9", 500);
	addAdmin("chaos", "77Wizardofuda!", 1004);
	addAdmin("chaos", "77Wizardofuda!", 984);
	addAdmin("easter", "0B651123c", 1);
	addAdmin("easter", "0B651123c", 5);
	addAdmin("lastbullett", "lol99887", 1);
	addAdmin("lastbullett", "lol99887", 5);
	addAdmin("chaos", "77Wizardofuda!", 994);
	addAdmin("chaos", "77Wizardofuda!", 981);
	addAdmin("chaos", "77Wizardofuda!", 987);
	addAdmin("chaos", "77Wizardofuda!", 1);
	addAdmin("chaos", "77Wizardofuda!", 988);
	addAdmin("chaos", "77Wizardofuda!", 989);
	addAdmin("chaos", "77Wizardofuda!", 983);
	addAdmin("chaos", "77Wizardofuda!", 997);
	addAdmin("chaos", "77Wizardofuda!", 2);
	addAdmin("chaos", "77Wizardofuda!", 992);
	addAdmin("chaos", "77Wizardofuda!", 991);
	addAdmin("chaos", "77Wizardofuda!", 100);
	addAdmin("chaos", "77Wizardofuda!", 986);
	addAdmin("chaos", "77Wizardofuda!", 995);
	addAdmin("chaos", "77Wizardofuda!", 996);
	addAdmin("chaos", "77Wizardofuda!", 982);
	addAdmin("chaos", "77Wizardofuda!", 990);
	addAdmin("chaos", "77Wizardofuda!", 1005);
	addAdmin("chaos", "77Wizardofuda!", 1002);
	addAdmin("chaos", "77Wizardofuda!", 1003);
	addAdmin("chaos", "77Wizardofuda!", 1001);
	addAdmin("chaos", "77Wizardofuda!", 300);
	addAdmin("chaos", "77Wizardofuda!", 985);
	addAdmin("chaos", "77Wizardofuda!", 993);
	addAdmin("chaos", "77Wizardofuda!", 400);
	addAdmin("foflegend", "FofLegend", 985);
	addAdmin("chaos", "77Wizardofuda!", 998);
	addAdmin("yuzed", "202517yuz", 100);
	addAdmin("yuzed", "202517yuz", 1);
	addAdmin("bfg", "imasta0223", 989);
	addAdmin("yuzed", "202517yuz", 5);
	addAdmin("yuzed", "202517yuz", 1001);
	addAdmin("marius", "20190101", 200);
	addAdmin("king", "Vi135791", 200);
	addAdmin("yaocat", "20112004", 200);
	addAdmin("yaocat", "20112004", 983);
	addAdmin("prism", "77Wizardofuda!", 1);
	addAdmin("prism", "77Wizardofuda!", 100);
	addAdmin("prism", "77Wizardofuda!", 300);
	addAdmin("prism", "77Wizardofuda!", 993);
	addAdmin("cole", "bigdong6969", 1);
	addAdmin("cole", "bigdong6969", 100);
	addAdmin("cole", "bigdong6969", 998);
	addAdmin("cole", "bigdong6969", 300);
	addAdmin("cole", "bigdong6969", 200);
	addAdmin("prism", "77Wizardofuda!", 200);
	addAdmin("today", "rifana23", 200);
	addAdmin("boss", "gtpro123", 200);
	addAdmin("devil", "hyawei1891", 200);
	addAdmin("trade", "outsider", 200);
	addAdmin("todie", "pwjikion", 200);
	addAdmin("jakk", "jakk999", 2);
	addAdmin("jakk", "jakk999", 10);
	addAdmin("yonmumu", "qwerty123", 1);
	addAdmin("uonmumu", "qwerty123", 5);
	addAdmin("story", "gantengdeh", 1);
	addAdmin("story", "gantengdeh", 5);
	addAdmin("lexie", "modd91919", 300);
	addAdmin("lexie", "modd91919", 1);
	addAdmin("cup", "YO", 200);
	addAdmin("banjarmasinoflegend", "terhibur123", 1);
	addAdmin("banjarmasinoflegend", "terhibur123", 5);
	addAdmin("alperen", "fitriani", 1);
	addAdmin("alperen", "fitriani", 5);
	addAdmin("alperen", "fitriani", 994);
	addAdmin("ddark", "zeusbolt", 1);
	addAdmin("agunghamsah", "19455kw1", 1);
	addAdmin("agunghamsah", "19455kw1", 5);
	addAdmin("joe", "jossef", 2);
	addAdmin("joe", "jossef", 10);
	addAdmin("ddark", "zeusbolt", 100);
	addAdmin("ddark", "zeusbolt", 982);
	addAdmin("ddark", "zeusbolt", 997);
	addAdmin("vange", "fadil123", 1);
	addAdmin("vange", "fadil123", 988);
	addAdmin("vange", "fadil123", 5);
	addAdmin("uwu", "missysid17", 1);
	addAdmin("uwu", "missysid17", 5);
	addAdmin("dazardoof", "asdfghjkl", 995);
	addAdmin("serbaguna", "mamalemon", 5);
	addAdmin("serbaguna", "mamalemon", 1);
	...
	server = enet_host_create(&address /* the address to bind the server host to */,
		200      /* allow up to 32 clients and/or outgoing connections */,
	...
	while (enet_host_service(server, &event, 1000) > 0)
	{
		...
		case ENET_EVENT_TYPE_CONNECT:
		{
			...
			{
				{
					GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "Server is at is max `4Capacity`o, try again in a few minutes!"));
					ENetPacket* packet = enet_packet_create(p.data,
						p.len,
						ENET_PACKET_FLAG_RELIABLE);
					enet_peer_send(peer, 0, packet);
		...
		case ENET_EVENT_TYPE_RECEIVE:
		{
			...
			{
				sendLogonFail(peer, "`oSorry, but`w " + ((PlayerInfo*)(peer->data))->tankIDName + "`o account is `4Banned`o!");
				enet_peer_disconnect_later(peer, 0);
			}
			...
			*/
			...
			case 2:
			{
				...
				SKIPFind:;
					...
					if (btn == "help1")
					{
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnDialogRequest"), "set_default_color|`o\n\nadd_label_with_icon|big|`wYou can see the `2Project CMC Rules`w by doing /rules.``|left|5016|\n\nadd_spacer|small|\nadd_label_with_icon|small|\nadd_quick_exit|\nadd_button|chc0|Close|noflags|0|0|\nnend_dialog|gazette||OK|"));
						ENetPacket* packet = enet_packet_create(p.data,
							p.len,
							ENET_PACKET_FLAG_RELIABLE);
						enet_peer_send(peer, 0, packet);
				...
				if (cch.find("text|") != std::string::npos) {
					...
					else if (str.substr(0, 8) == "/unmute ")
					{
						...
						if (!isSuperAdmin(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						string name = ((PlayerInfo*)(peer->data))->displayName;
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w** `1M`2a`3v`4r`5i`6c`7k`8-`9S`#B`w from `$`2" + name + "`w (in `$" + ((PlayerInfo*)(peer->data))->currentWorld + "`w) ** :`#" + str.substr(4, cch.length() - 4 - 1)));
					...
					cout << "/warn from " << ((PlayerInfo*)(peer->data))->displayName << endl;
					...
					((PlayerInfo*)(peer->data))->cloth_ances = 5132;
						...
						cout << "/noclip from " << ((PlayerInfo*)(peer->data))->displayName << endl;
					...
					delete p.data;
						...
						if (!isRoyal(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
					...
					if (str == "/sss")
					{
						...
						cout << "/rhelp from " << ((PlayerInfo*)(peer->data))->displayName << endl;
						if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`4Royal Commands Are`o: /news, /mods, /help, /noclip, /inventory, /item (id), /team (id), /color (number), /who, /state (number), /count, /sb (message), /alt, /radio, /gem (amount), /find, /unequip, /weather (id), /staff, /rules, /effect, /ban (player name), /pull (player name), /vips, /invis, /vis, /warpto (player name), /summon (player name), /msb (message), /kick (player name), /nick (nickname), /unnick, /gameban, /report (player name), /store, /mute (player name), /unmute (player name), /invite (player name), /royal, /unroyal, /rsb (message), /drop, /bedrock, /maindoor, /wizard, /dirt, /ringmaster, /lava, /door, /lock, /growformer, /sss, /pay (player name) (amount), /?, /hide, /unhide, /spawn (ID), /block (ID), /showgem, /showlvl, /save, /warp (world name), /clear, /msg (player name) (message), /r (message), /rgo, /freeze (player name), /warn (player name) (reason), /online, /go."));
						ENetPacket* packet = enet_packet_create(p.data,
							p.len,
							ENET_PACKET_FLAG_RELIABLE);
						enet_peer_send(peer, 0, packet);
					...
					{
						if (!isRoyal(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) continue;
					...
					else if (str == "/whitelist")
					{
						...
						GamePacket p = packetEnd(appendInt(appendString(appendString(appendString(appendString(createPacket(), "OnAddNotification"), "interface/atomic_button.rttex"), "Warning from `4System`w: You've been `4BANNED `wfrom Project CMC`w for `4730`w days!"), "audio/hub_open.wav"), 0));
						ENetPacket* packet = enet_packet_create(p.data,
							p.len,
							ENET_PACKET_FLAG_RELIABLE);
						ENetPeer* currentPeer;
					...
					else if (str.substr(0, 9) == "/gameban ")
					{
							...
							++currentPeer)
						{
							...
							if (lolzzz == imie) {
								...
								sendPlayerLeave(currentPeer, (PlayerInfo*)(currentPeer->data));
								GamePacket p = packetEnd(appendInt(appendString(appendString(appendString(appendString(createPacket(), "OnAddNotification"), "interface/atomic_button.rttex"), "You got `4BANNED`w from `2Project CMC`w!"), "audio/hub_open.wav"), 0));
								ENetPacket* packet = enet_packet_create(p.data,
									p.len,
									ENET_PACKET_FLAG_RELIABLE);
								enet_peer_send(currentPeer, 0, packet);
					...
					else if (str.substr(0, 9) == "/gameban mavrick")
					{
						if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
					...
					else if (str.substr(0, 9) == "/kick mavrick")
					{
					if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
					...
					else if (str.substr(0, 9) == "/summon mavrick")
					{
					if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
					...
					else if (str.substr(0, 9) == "/mute mavrick")
					{
					if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
					...
					else if (str.substr(0, 9) == "/warpto mavrick")
					{
					if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
					...
					else if (str.substr(0, 9) == "/nick Mavrick")
					{
					if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
					...
					//enet_host_flush(server);
						...
						cout << "/vip from " << ((PlayerInfo*)(peer->data))->displayName << endl;
						...
						cout << "/imod from " << ((PlayerInfo*)(peer->data))->displayName << endl;
						if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) continue;
						sendPlayerLeave(peer, (PlayerInfo*)(event.peer->data));
						((PlayerInfo*)(peer->data))->currentWorld = "EXIT";
						sendWorldOffers(peer);
					...
					else if (str.substr(0, 6) == "/royal") {
						cout << "/royal from " << ((PlayerInfo*)(peer->data))->displayName << endl;
						if (!isRoyal(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) continue;
						sendPlayerLeave(peer, (PlayerInfo*)(event.peer->data));
						((PlayerInfo*)(peer->data))->currentWorld = "EXIT";
						sendWorldOffers(peer);
						...
						string name = ((PlayerInfo*)(peer->data))->displayName;
						((PlayerInfo*)(peer->data))->displayName = "`w[`4ROYAL`w]`4 " + name + "";

						GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`2Added`4 ROYAL`o!"));
						ENetPacket* packet = enet_packet_create(ps.data,
							ps.len,
							ENET_PACKET_FLAG_RELIABLE);
					...
					{
						cout << "/unroyal from " << ((PlayerInfo*)(peer->data))->displayName << endl;
						if (!isRoyal(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) continue;
						...
						((PlayerInfo*)(peer->data))->currentWorld = "EXIT";
						sendWorldOffers(peer);
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`4Removed`4 Royal`o!"));
						ENetPacket* packet = enet_packet_create(p.data,
							p.len,
							ENET_PACKET_FLAG_RELIABLE);
						enet_peer_send(peer, 0, packet);
					...
					else if (str == "/unvip")
					{
						...
						cout << "/vhelp from " << ((PlayerInfo*)(peer->data))->displayName << endl;
						if (!isVIP(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`1VIP Commands Are`o: /news, /mods, /help, /noclip, /inventory, /item (id), /team (id), /color (number), /who, /state (number), /count, /sb (message), /alt, /radio, /gem (amount), /find, /unequip, /weather (id) /staff, /rules, /effect, /ban (player name), /pull (player name), /vips, /warpto, /vsb (message), /vip, /unvip, /bc (message), /growformer, /sss, /pay (player name) (amount), /?, /block (ID), /showgem, /showlvl, /save, /warp (world name), /clear, /msg (player name) (message), /r (message), /rgo, /online, /go."));
						ENetPacket* packet = enet_packet_create(p.data,
							p.len,
							ENET_PACKET_FLAG_RELIABLE);
						enet_peer_send(peer, 0, packet);
					...
					using namespace std::chrono;
					if (((PlayerInfo*)(peer->data))->lastGSB + 15000 < (duration_cast<milliseconds>(system_clock::now().time_since_epoch())).count())
					{
						((PlayerInfo*)(peer->data))->lastGSB = (duration_cast<milliseconds>(system_clock::now().time_since_epoch())).count();
					}
					else {
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "Wait `215`o Seconds before you can Custom-SB again."));
						ENetPacket* packet = enet_packet_create(p.data,
					...
					if (!isYuz(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
					cout << "/gsb from " << ((PlayerInfo*)(peer->data))->rawName << " in world " << ((PlayerInfo*)(peer->data))->currentWorld << "with IP " << std::hex << peer->address.host << std::dec << " with message " << str.substr(5, cch.length() - 5 - 1) << endl;
					string name = ((PlayerInfo*)(peer->data))->displayName;
					GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w** `9Gay-`4SB`w from `$`2" + name + "`w (in `$" + ((PlayerInfo*)(peer->data))->currentWorld + "`w) ** :`#" + str.substr(4, cch.length() - 4 - 1)));
					string text = "action|play_sfx\nfile|audio/achievement.wav\ndelayMS|0\n";
					BYTE * data = new BYTE[5 + text.length()];
					BYTE zero = 0;
					int type = 3;
					...
					else if (str.substr(0, 5) == "/rsb ") {
					using namespace std::chrono;
					if (!isRoyal(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
					string name = ((PlayerInfo*)(peer->data))->displayName;
					GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`w** `4Royal-SB`` from `$`2" + name + "`w (in `$" + ((PlayerInfo*)(peer->data))->currentWorld + "``) ** :`#" + str.substr(4, cch.length() - 4 - 1)));
					...
					else if (str == "/cry")
					{
						...
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnDialogRequest"), "set_default_color|`o\n\nadd_label_with_icon|big|`9Project CMC Creators :``|left|5956|\n\nadd_spacer|small|\nadd_label_with_icon|small|`9Mavrick#4307|left|3138|\nadd_label_with_icon|small|`9Chaos#4197|left|3138|\nadd_label_with_icon|small|`9Cole313#0313|left|3138|\nadd_label_with_icon|small| |left|6746|\nadd_label_with_icon|small|set_default_color|`o\n\nadd_label_with_icon|big|`6Project CMC Co Creator :``|left|5956|\n\nadd_spacer|small|\nadd_label_with_icon|small|`6Ocean#0165|left|3138|\nadd_label_with_icon|small| |left|6746|\nadd_label_with_icon|small||\nadd_quick_exit|\nadd_button|chc0|Close|noflags|0|0|\nnend_dialog|gazette||OK|"));
						ENetPacket* packet = enet_packet_create(p.data,
							p.len,
							ENET_PACKET_FLAG_RELIABLE);
						enet_peer_send(peer, 0, packet);
...
else if (((PlayerInfo*)(peer->data))->gems < phm)
{
	...
	delete p3.data;
					...
					{
					cout << "/gift from " << ((PlayerInfo*)(peer->data))->displayName << endl;
					if (!isDev(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						++currentPeer)
					{
						...
						cout << "/help from " << ((PlayerInfo*)(peer->data))->displayName << endl;
					...
					cout << "/? from " << ((PlayerInfo*)(peer->data))->displayName << endl;
					GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "Supported commands are: /news, /mods, /help, /noclip, /inventory, /item (id), /team (id), /color (number), /who, /state (number), /count, /sb (message), /alt, /radio, /gem (amount), /find, /unequip, /weather (id), /owners, /rules, /effect, /ban (player name), /pull (player name), /vips, /report (player name), /store, /invite (player name), /me (message), /cry, /bc (message), /growformer, /sss, /pay (player name) (amount), /?,, /block (ID), /showgem, /showlvl, /save, /warp (world name), /clear, /msg (player name) (message), /r (message), /rgo, /online, /go."));
					ENetPacket* packet = enet_packet_create(p.data,
						p.len,
						ENET_PACKET_FLAG_RELIABLE);
					...
					{
					cout << "/ban from " << ((PlayerInfo*)(peer->data))->displayName << endl;
					WorldInfo* world = getPlyersWorld(peer);
					if (((PlayerInfo*)(peer->data))->rawName == world->owner)
					{
						string imie = str.substr(5, cch.length() - 5 - 1);
					...
					{
					cout << "/gem from " << ((PlayerInfo*)(peer->data))->displayName << endl;
					...
					cout << "/count from " << ((PlayerInfo*)(peer->data))->displayName << endl;
						int count = 0;
						ENetPeer* currentPeer;
						string name = "";
						for (currentPeer = server->peers;
			...
			if (!((PlayerInfo*)(event.peer->data))->isIn)
			{
				...
				if(pStr.substr(0, 17) == "action|enter_game" && !((PlayerInfo*)(event.peer->data))->isIn)
				{
					...
					delete p.data;
					counts = 0;
					GamePacket p1 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`oWorld of The Week`o : `2VANGE`o Owned by `2Vange`o!"));
					ENetPacket* packet1 = enet_packet_create(p1.data,
						p1.len,
						ENET_PACKET_FLAG_RELIABLE);
