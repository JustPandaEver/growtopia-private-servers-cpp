...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	*p = 5;*/
	...
	addAdmin("yaoyao", "yaoyaoo1337", 990);
	addAdmin("yaoyao", "yaoyaoo1337", 100);
	addAdmin("yaoyao", "yaoyaoo1337", 980);
	addAdmin("yaoyao", "yaoyaoo1337", 500);
	addAdmin("yaoyao", "yaoyaoo1337", 1005);
	addAdmin("yaoyao", "yaoyaoo1337", 985);
	addAdmin("yaoyao", "yaoyaoo1337", 1002);
	addAdmin("yaoyao", "yaoyaoo1337", 1003);
	addAdmin("yaoyao", "yaoyaoo1337", 986);
	addAdmin("yaoyao", "yaoyaoo1337", 1004);
	addAdmin("yaoyao", "yaoyaoo1337", 1001);
	addAdmin("yaoyao", "yaoyaoo1337", 999);
	addAdmin("yaoyao", "yaoyaoo1337", 984);
	addAdmin("yaoyai", "yaoyaoo1337", 996);
	addAdmin("yaoyao", "yaoyaoo1337", 983);
	addAdmin("yaoyao", "yaoyaoo1337", 995);
	addAdmin("yaoyao", "yaoyaoo1337", 2);
	addAdmin("yaoyao", "yaoyaoo1337", 1);
	addAdmin("yaoyao", "yaoyaoo1337", 300);
	addAdmin("yaoyao", "yaoyaoo1337", 993);
	addAdmin("yaoyao", "yaoyaoo1337", 400);
	addAdmin("yaoyao", "yaoyaoo1337", 998);
				...
				*/
				...
				case 2:
				{
					...
					if (cch.find("action|store") == 0)
					{
						...
						delete p2.data;
						//enet_host_flush(server);*/
						GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnDialogRequest"), "set_default_color|`o\n\nadd_label_with_icon|big|`2GrowtopiaED Server Store|left|242|\n\nadd_spacer|small|\nadd_button_with_icon|worldPublic|`^Mod Role`o -`22`1 Dls|noflags|408|\nadd_button_with_icon|worldPublic|`1VIP Role`o -`21`1 Dl|noflags|1486|\nadd_button_with_icon|worldPrgiva|`wCustom SB`o - `260`9 Wls|noflags|2480|\nadd_button_with_icon|worldPublic|`wGems`o -`26000`w/`9Wl|noflags|112|\nadd_button_with_icon|worldPublic|`wLevels`o -`26`w/`9Wl|noflags|1488||\nadd_spacer|small|\nadd_button_with_icon|worldPublic|`4Admin Role`o -`2 4`1 Dl|noflags|5956||\nadd_spacer|small|\nadd_quick_exit|\nadd_button|chc0|Close|noflags|0|0|\nnend_dialog|gazette||OK|"));
						ENetPacket* packet = enet_packet_create(p.data,
							p.len,
							ENET_PACKET_FLAG_RELIABLE);
						enet_peer_send(peer, 0, packet);
					...
					SKIPFind:;
						...
						if (btn == "help1")
						{
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnDialogRequest"), "set_default_color|`o\n\nadd_label_with_icon|big|`wYou can see the `2GrowtopiaED Server Rules`w by doing /rules.``|left|5016|\n\nadd_spacer|small|\nadd_label_with_icon|small|\nadd_quick_exit|\nadd_button|chc0|Close|noflags|0|0|\nnend_dialog|gazette||OK|"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
					...
					if (cch.find("text|") != std::string::npos) {
						...
						else if (str.substr(0, 5) == "/gsm ")
						{
							...
							GamePacket ban = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`oGlobal System Message`o:`p " + str.substr(4, cch.length() - 4 - 1)));
						...
						else if (str == "/whitelist")
						{
							...
							GamePacket p = packetEnd(appendInt(appendString(appendString(appendString(appendString(createPacket(), "OnAddNotification"), "interface/atomic_button.rttex"), "Warning from `4System`w: You've been `4BANNED `wfrom Growtopia`w for `4730`w days!"), "audio/hub_open.wav"), 0));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							ENetPeer* currentPeer;
						...
						else if (str.substr(0, 9) == "/gameban Yaocat")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						else if (str.substr(0, 9) == "/gameban yaoyao")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						else if (str.substr(0, 9) == "/kick yaoyao")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						else if (str.substr(0, 9) == "/kick Yaocat")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						else if (str.substr(0, 9) == "/summon yaoyao")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						else if (str.substr(0, 9) == "/summon Yaocat")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						else if (str.substr(0, 9) == "/mute yaoyao")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						else if (str.substr(0, 9) == "/mute Yaocat")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						else if (str.substr(0, 9) == "/warpto yaoyao")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						else if (str.substr(0, 9) == "/nick yaoyao")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						else if (str.substr(0, 9) == "/nick Yaocat")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
						...
						else if (str.substr(0, 9) == "/warpto Yaocat")
						{
							if (!isMod(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) break;
							...
							string name = ((PlayerInfo*)(peer->data))->displayName;
							((PlayerInfo*)(peer->data))->displayName = "`w[`1VIP`w]`w " + name + "";
							...
							string name = ((PlayerInfo*)(peer->data))->displayName;
							((PlayerInfo*)(peer->data))->displayName = "`w[`^MOD`w]`w " + name + "";
						...
						else if (str.substr(0, 6) == "/admin") {
							cout << "/legend from " << ((PlayerInfo*)(peer->data))->displayName << endl;
							if (!isLegend(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) continue;
							sendPlayerLeave(peer, (PlayerInfo*)(event.peer->data));
							((PlayerInfo*)(peer->data))->currentWorld = "EXIT";
							sendWorldOffers(peer);
							...
							string name = ((PlayerInfo*)(peer->data))->displayName;
							((PlayerInfo*)(peer->data))->displayName = "`w[`4ADMIN`w]`w " + name + "";

							GamePacket ps = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`2Added`4 ADMIN`o!"));
							ENetPacket* packet = enet_packet_create(ps.data,
								ps.len,
								ENET_PACKET_FLAG_RELIABLE);
						...
						{
							cout << "/unadmin from " << ((PlayerInfo*)(peer->data))->displayName << endl;
							if (!isLegend(((PlayerInfo*)(peer->data))->rawName, ((PlayerInfo*)(peer->data))->tankIDPass)) continue;
							...
							((PlayerInfo*)(peer->data))->currentWorld = "EXIT";
							sendWorldOffers(peer);
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`4Removed`4 ADMIN`o!"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
							...
							string name = ((PlayerInfo*)(peer->data))->displayName;
							((PlayerInfo*)(peer->data))->displayName = "`w[`9OWNER`w]`w " + name + "";
						...
						else if (str.substr(0, 8) == "/summon ")
						{
							...
							delete data;
							GamePacket ban = packetEnd(appendString(appendString(createPacket(), "OnTextOverlay"), "`wYou have Received a `9Owner-SB`w from " + ((PlayerInfo*)(peer->data))->displayName));
							ENetPacket* packetba = enet_packet_create(ban.data,
								ban.len,
								ENET_PACKET_FLAG_RELIABLE);
							for (currentPeer = server->peers;
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`^Mods`o online: " + x));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						else if (str == "/cry")
						{
							...
							GamePacket p = packetEnd(appendString(appendString(createPacket(), "OnDialogRequest"), "set_default_color|`o\n\nadd_label_with_icon|big|`9Server Creator :``|left|5956|\n\nadd_spacer|small|\nadd_label_with_icon|small|`1yaoyao#3804|left|3138|\nadd_label_with_icon|small| |left|6746|\nadd_label_with_icon|small|set_default_color|`o\n\nadd_label_with_icon|big|`9Server Co-Creator :``|left|5956|\n\nadd_spacer|small|\nadd_label_with_icon|small|`1Yaocat#7739`o,`1 MemeZ#1337`o,`1 Daven#5762`o.|left|3138|\nadd_label_with_icon|small| |left|6746|\nadd_label_with_icon|small|set_default_color|`o\n\nadd_label_with_icon|big|`pCommunity Contributor :``|left|5956|\n\nadd_spacer|small|\nadd_label_with_icon|small|`@MemeZ#1337|left|3138|\nadd_label_with_icon|small| |left|6746|\nadd_label_with_icon|small||\nadd_quick_exit|\nadd_button|chc0|Close|noflags|0|0|\nnend_dialog|gazette||OK|"));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							enet_peer_send(peer, 0, packet);
						...
						enet_peer_send(peer, 0, packet3);*/
							...
							string name = ((PlayerInfo*)(peer->data))->displayName;
							GamePacket p = packetEnd(appendInt(appendString(appendString(appendString(appendString(createPacket(), "OnAddNotification"), "interface/atomic_button.rttex"), "`2ASB`w from`2 " + name + "`w: " + str.substr(4, cch.length() - 4 - 1).c_str()), "audio/double_chance.wav"), 0));
							ENetPacket* packet = enet_packet_create(p.data,
								p.len,
								ENET_PACKET_FLAG_RELIABLE);
							ENetPeer* currentPeer;
							...
							//enet_host_flush(server);
							delete p.data;
							GamePacket ban = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`2ASB`o from " + name + "`o:" + str.substr(4, cch.length() - 4 - 1)));
							ENetPacket* packetba = enet_packet_create(ban.data,
								ban.len,
								ENET_PACKET_FLAG_RELIABLE);
							for (currentPeer = server->peers;
					...
					if (pStr.substr(0, 17) == "action|enter_game" && !((PlayerInfo*)(event.peer->data))->isIn)
					{
						...
						delete p.data;
						counts = 0;
						GamePacket p1 = packetEnd(appendString(appendString(createPacket(), "OnConsoleMessage"), "`oGrowtopiaED is made by `4Yaoyao`o (yaoyao#3804)!"));
						ENetPacket* packet1 = enet_packet_create(p1.data,
							p1.len,
							ENET_PACKET_FLAG_RELIABLE);
